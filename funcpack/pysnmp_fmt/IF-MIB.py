...
# Produced by pysmi-0.3.4 at Thu Jun 20 22:21:06 2019
...
IpAddress, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, MibIdentifier, mib_2, ObjectIdentity, Gauge32, Counter32, Integer32, NotificationType, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "MibIdentifier", "mib-2", "ObjectIdentity", "Gauge32", "Counter32", "Integer32", "NotificationType", "ModuleIdentity", "Counter64")
TestAndIncr, AutonomousType, RowStatus, DisplayString, TruthValue, TextualConvention, TimeStamp, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "AutonomousType", "RowStatus", "DisplayString", "TruthValue", "TextualConvention", "TimeStamp", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifMtu=ifMtu, ifPhysAddress=ifPhysAddress, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifInNUcastPkts=ifInNUcastPkts, ifHCInOctets=ifHCInOctets, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressAddress=ifRcvAddressAddress, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifTestCode=ifTestCode, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestId=ifTestId, ifSpeed=ifSpeed, ifRcvAddressStatus=ifRcvAddressStatus, ifHighSpeed=ifHighSpeed, ifCompliance=ifCompliance, ifOutQLen=ifOutQLen, interfaces=interfaces, ifRcvAddressType=ifRcvAddressType, ifStackEntry=ifStackEntry, ifHCOutOctets=ifHCOutOctets, ifTestEntry=ifTestEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifInDiscards=ifInDiscards, ifTestTable=ifTestTable, PYSNMP_MODULE_ID=ifMIB, ifMIBObjects=ifMIBObjects, ifXEntry=ifXEntry, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifEntry=ifEntry, ifAlias=ifAlias, ifAdminStatus=ifAdminStatus, linkUp=linkUp, ifRcvAddressTable=ifRcvAddressTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifDescr=ifDescr, ifStackLastChange=ifStackLastChange, ifConnectorPresent=ifConnectorPresent, ifConformance=ifConformance, ifStackGroup=ifStackGroup, ifHCPacketGroup=ifHCPacketGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifGeneralGroup=ifGeneralGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifStackGroup2=ifStackGroup2, ifCompliance2=ifCompliance2, InterfaceIndex=InterfaceIndex, ifOutErrors=ifOutErrors, ifGroups=ifGroups, ifPromiscuousMode=ifPromiscuousMode, ifOperStatus=ifOperStatus, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCompliance3=ifCompliance3, ifRcvAddressEntry=ifRcvAddressEntry, ifNumber=ifNumber, ifName=ifName, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifLastChange=ifLastChange, ifStackHigherLayer=ifStackHigherLayer, ifCompliances=ifCompliances, ifFixedLengthGroup=ifFixedLengthGroup, ifOutUcastPkts=ifOutUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestOwner=ifTestOwner, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInErrors=ifInErrors, ifSpecific=ifSpecific, ifOutNUcastPkts=ifOutNUcastPkts, ifTable=ifTable, ifInOctets=ifInOctets, ifInUcastPkts=ifInUcastPkts, ifTableLastChange=ifTableLastChange, ifTestResult=ifTestResult, ifStackStatus=ifStackStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestGroup=ifTestGroup, ifOutOctets=ifOutOctets, ifStackTable=ifStackTable, ifMIB=ifMIB, ifTestStatus=ifTestStatus, OwnerString=OwnerString, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkDown=linkDown, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestType=ifTestType, ifOldObjectsGroup=ifOldObjectsGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutDiscards=ifOutDiscards, ifInMulticastPkts=ifInMulticastPkts, ifType=ifType, ifIndex=ifIndex, ifXTable=ifXTable)
