...
Counter64, ModuleIdentity, Integer32, MibIdentifier, NotificationType, mib_2, TimeTicks, iso, IpAddress, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Integer32", "MibIdentifier", "NotificationType", "mib-2", "TimeTicks", "iso", "IpAddress", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "ObjectIdentity")
TimeStamp, TDomain, TruthValue, RowPointer, AutonomousType, DisplayString, TAddress, DateAndTime, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TDomain", "TruthValue", "RowPointer", "AutonomousType", "DisplayString", "TAddress", "DateAndTime", "TextualConvention")
...
mibBuilder.exportSymbols("ENTITY-MIB", entLogicalTDomain=entLogicalTDomain, entPhysicalUris=entPhysicalUris, entPhysicalUUID=entPhysicalUUID, entPhysicalSoftwareRev=entPhysicalSoftwareRev, entPhysicalAlias=entPhysicalAlias, entPhysicalContainsEntry=entPhysicalContainsEntry, entityMapping=entityMapping, PhysicalIndexOrZero=PhysicalIndexOrZero, entPhysicalParentRelPos=entPhysicalParentRelPos, entLogicalTAddress=entLogicalTAddress, entLogicalCommunity=entLogicalCommunity, entLPMappingTable=entLPMappingTable, entAliasLogicalIndexOrZero=entAliasLogicalIndexOrZero, entityCompliances=entityCompliances, entityMIBObjects=entityMIBObjects, entPhysicalFirmwareRev=entPhysicalFirmwareRev, entPhysicalIsFRU=entPhysicalIsFRU, entity2Compliance=entity2Compliance, entPhysicalModelName=entPhysicalModelName, entPhysicalName=entPhysicalName, entLogicalTable=entLogicalTable, entPhysicalChildIndex=entPhysicalChildIndex, entityMIBTrapPrefix=entityMIBTrapPrefix, entityCompliance=entityCompliance, entPhysicalDescr=entPhysicalDescr, entLogicalIndex=entLogicalIndex, entAliasMappingEntry=entAliasMappingEntry, entityLogical=entityLogical, entityLogicalGroup=entityLogicalGroup, entityGeneralGroup=entityGeneralGroup, entityPhysical4Group=entityPhysical4Group, entPhysicalVendorType=entPhysicalVendorType, entityGroups=entityGroups, entityMIB=entityMIB, entityPhysical2Group=entityPhysical2Group, entPhysicalContainedIn=entPhysicalContainedIn, entPhysicalMfgDate=entPhysicalMfgDate, entLastChangeTime=entLastChangeTime, entPhysicalContainsTable=entPhysicalContainsTable, entPhysicalMfgName=entPhysicalMfgName, entLogicalContextName=entLogicalContextName, entLPPhysicalIndex=entLPPhysicalIndex, entityNotificationsGroup=entityNotificationsGroup, PhysicalClass=PhysicalClass, entPhysicalEntry=entPhysicalEntry, entLogicalContextEngineID=entLogicalContextEngineID, entityLogical2Group=entityLogical2Group, SnmpEngineIdOrNone=SnmpEngineIdOrNone, entLogicalEntry=entLogicalEntry, entityMIBTraps=entityMIBTraps, entPhysicalClass=entPhysicalClass, entPhysicalTable=entPhysicalTable, PhysicalIndex=PhysicalIndex, entityPhysical3Group=entityPhysical3Group, entity4Compliance=entity4Compliance, entityPhysicalCRGroup=entityPhysicalCRGroup, entity3Compliance=entity3Compliance, entAliasMappingTable=entAliasMappingTable, entLPMappingEntry=entLPMappingEntry, entPhysicalIndex=entPhysicalIndex, PYSNMP_MODULE_ID=entityMIB, entConfigChange=entConfigChange, entLogicalDescr=entLogicalDescr, entityPhysicalGroup=entityPhysicalGroup, entPhysicalSerialNum=entPhysicalSerialNum, entityGeneral=entityGeneral, entityPhysical=entityPhysical, entityConformance=entityConformance, entAliasMappingIdentifier=entAliasMappingIdentifier, entity4CRCompliance=entity4CRCompliance, entityMappingGroup=entityMappingGroup, entPhysicalAssetID=entPhysicalAssetID, entPhysicalHardwareRev=entPhysicalHardwareRev, entLogicalType=entLogicalType)
