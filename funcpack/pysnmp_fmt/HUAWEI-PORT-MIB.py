...
mibBuilder.exportSymbols("HUAWEI-PORT-MIB", hwPosScramble=hwPosScramble, hwDs1FrameFormat=hwDs1FrameFormat, hwDs0ChannelBundleEntry=hwDs0ChannelBundleEntry, hwBundleSerialTimerHold=hwBundleSerialTimerHold, hwCposEntry=hwCposEntry, hwDs1IfIndex=hwDs1IfIndex, hwDs3ObjectGroup=hwDs3ObjectGroup, hwEthernetFlagJ1Mode=hwEthernetFlagJ1Mode, hwDs1CodeType=hwDs1CodeType, hwEthernetDuplex=hwEthernetDuplex, hwCpos=hwCpos, hwEthernetEntry=hwEthernetEntry, hwPosFlagJ1Trace=hwPosFlagJ1Trace, hwEthernetObjectGroup=hwEthernetObjectGroup, hwDs3ChannelType=hwDs3ChannelType, hwCposFlagJ1Mode=hwCposFlagJ1Mode, hwDs1Entry=hwDs1Entry, hwPosEntry=hwPosEntry, hwCposFlagJ0Value=hwCposFlagJ0Value, hwDs3Entry=hwDs3Entry, hwBundleSerialIfIndex=hwBundleSerialIfIndex, hwEthernetFlagJ0Trace=hwEthernetFlagJ0Trace, hwDs1RowStatus=hwDs1RowStatus, hwDs3Clock=hwDs3Clock, hwPosLinkProtocol=hwPosLinkProtocol, hwPosIfIndex=hwPosIfIndex, hwDs1Cable=hwDs1Cable, hwEthernetUpHoldTime=hwEthernetUpHoldTime, hwCposMultiplex=hwCposMultiplex, PYSNMP_MODULE_ID=hwPortMIB, hwCposFlagJ0Mode=hwCposFlagJ0Mode, hwBundleSerialLoopback=hwBundleSerialLoopback, hwEthernetSpeedSet=hwEthernetSpeedSet, hwDs3RowStatus=hwDs3RowStatus, hwEthernetClock=hwEthernetClock, hwDs0ChannelBundle=hwDs0ChannelBundle, hwBundleSerialLinkProtocol=hwBundleSerialLinkProtocol, hwPortConformance=hwPortConformance, hwCposFlagC2Value=hwCposFlagC2Value, hwDs0ChannelBundleId=hwDs0ChannelBundleId, hwDs0ChannelBundleTimeSlots=hwDs0ChannelBundleTimeSlots, hwDs3=hwDs3, hwBundleSerial=hwBundleSerial, hwEthernetFlagJ1Trace=hwEthernetFlagJ1Trace, hwCposClock=hwCposClock, hwEthernet=hwEthernet, hwEthernetDownHoldTime=hwEthernetDownHoldTime, hwDs3IfType=hwDs3IfType, hwDs3Cable=hwDs3Cable, hwEthernetNegotiation=hwEthernetNegotiation, hwCposFlagJ1Trace=hwCposFlagJ1Trace, hwBundleSerialCrcVerifyCode=hwBundleSerialCrcVerifyCode, hwCposIfIndex=hwCposIfIndex, hwBundleSerialEntry=hwBundleSerialEntry, hwDs1Table=hwDs1Table, hwPortCompliances=hwPortCompliances, hwDs1Loopback=hwDs1Loopback, hwPosTable=hwPosTable, hwDs0ChannelBundleParentIfIndex=hwDs0ChannelBundleParentIfIndex, hwPosFlagJ1Value=hwPosFlagJ1Value, hwEthernetLoopback=hwEthernetLoopback, hwDs0ChannelBundleRowStatus=hwDs0ChannelBundleRowStatus, hwDs1ChannelType=hwDs1ChannelType, hwDs3CreateSerial=hwDs3CreateSerial, hwDs3ParentIfIndex=hwDs3ParentIfIndex, hwDs3Loopback=hwDs3Loopback, hwPosLoopback=hwPosLoopback, hwPosClock=hwPosClock, hwDs0ChannelBundleObjectGroup=hwDs0ChannelBundleObjectGroup, hwEthernetIfIndex=hwEthernetIfIndex, hwEthernetFlagC2Value=hwEthernetFlagC2Value, hwPortGroups=hwPortGroups, hwDs1=hwDs1, hwEthernetFlagJ1Value=hwEthernetFlagJ1Value, hwPosFlagJ1Mode=hwPosFlagJ1Mode, hwPosFrameFormat=hwPosFrameFormat, hwPos=hwPos, hwDs3IfIndex=hwDs3IfIndex, hwDs0ChannelBundleIfIndex=hwDs0ChannelBundleIfIndex, hwEthernetFlagJ0Mode=hwEthernetFlagJ0Mode, hwCposIfType=hwCposIfType, hwDs1ParentIfIndex=hwDs1ParentIfIndex, hwDs1ChannelId=hwDs1ChannelId, hwPosFlagJ0Value=hwPosFlagJ0Value, hwEthernetPortType=hwEthernetPortType, hwDs3Channelized=hwDs3Channelized, hwDs0ChannelBundleTable=hwDs0ChannelBundleTable, hwEthernetPortTypeOperate=hwEthernetPortTypeOperate, hwEthernetSubinterfaceStatisticEnable=hwEthernetSubinterfaceStatisticEnable, hwDs3Table=hwDs3Table, hwEthernetTable=hwEthernetTable, hwPosFlagJ0Trace=hwPosFlagJ0Trace, hwDs3NationalBit=hwDs3NationalBit, hwDs1Channelized=hwDs1Channelized, hwPortMIBObjects=hwPortMIBObjects, hwDs3ChannelId=hwDs3ChannelId, hwPortMIB=hwPortMIB, hwPosCrcVerifyCode=hwPosCrcVerifyCode, hwDs0ChannelBundleSpeed=hwDs0ChannelBundleSpeed, hwEthernetFlagJ0Value=hwEthernetFlagJ0Value, hwDs3FrameFormat=hwDs3FrameFormat, hwDs3Scramble=hwDs3Scramble, hwCposLoopback=hwCposLoopback, hwCposTable=hwCposTable, hwPortCompliance=hwPortCompliance, hwPosObjectGroup=hwPosObjectGroup, hwBundleSerialObjectGroup=hwBundleSerialObjectGroup, hwCposFlagJ1Value=hwCposFlagJ1Value, hwCposFrameFormat=hwCposFrameFormat, hwDs1IfType=hwDs1IfType, hwCposObjectGroup=hwCposObjectGroup, hwDs1Clock=hwDs1Clock, hwDs0ChannelBundleDs1ChannelId=hwDs0ChannelBundleDs1ChannelId, hwPosFlagJ0Mode=hwPosFlagJ0Mode, hwCposFlagJ0Trace=hwCposFlagJ0Trace, hwDs1ObjectGroup=hwDs1ObjectGroup, hwPosFlagC2Value=hwPosFlagC2Value, hwBundleSerialTable=hwBundleSerialTable)
