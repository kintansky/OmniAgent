...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/HUAWEI-ENTITY-EXTENT-MIB
...
entPhysicalIndex, entPhysicalVendorType, PhysicalClass, PhysicalIndex = mibBuilder.importSymbols("ENTITY-MIB", "entPhysicalIndex", "entPhysicalVendorType", "PhysicalClass", "PhysicalIndex")
hwDatacomm, = mibBuilder.importSymbols("HUAWEI-MIB", "hwDatacomm")
InterfaceIndex, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndex")
EnabledStatus, = mibBuilder.importSymbols("P-BRIDGE-MIB", "EnabledStatus")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
Counter64, ModuleIdentity, Integer32, MibIdentifier, NotificationType, TimeTicks, iso, IpAddress, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Integer32", "MibIdentifier", "NotificationType", "TimeTicks", "iso", "IpAddress", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Unsigned32", "ObjectIdentity")
RowStatus, DisplayString, AutonomousType, DateAndTime, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "AutonomousType", "DateAndTime", "TextualConvention")
...
mibBuilder.exportSymbols("HUAWEI-ENTITY-EXTENT-MIB", hwEntityGlobalPara=hwEntityGlobalPara, hwEntityCpuUsageThreshold=hwEntityCpuUsageThreshold, hwEntityMemoryAvgUsage=hwEntityMemoryAvgUsage, hwEntityExtTrapsPrefix=hwEntityExtTrapsPrefix, hwEntityBomEnDesc=hwEntityBomEnDesc, hwEntityVolSlot=hwEntityVolSlot, hwEntityCpuUsageLowThreshold=hwEntityCpuUsageLowThreshold, hwEntityExtNotificationGroup=hwEntityExtNotificationGroup, hwPhysicalPortBip8StatisticsES=hwPhysicalPortBip8StatisticsES, hwEntityExtCpuUsageLowThresholdNotfication=hwEntityExtCpuUsageLowThresholdNotfication, hwDisposeSlot=hwDisposeSlot, hwEntityOpticalRxLowWarnThreshold=hwEntityOpticalRxLowWarnThreshold, hwPhysicalPortBip8StatisticsEB=hwPhysicalPortBip8StatisticsEB, hwEntityOpticalTransDistance=hwEntityOpticalTransDistance, hwEntityBoardPower=hwEntityBoardPower, hwEntityCLEICode=hwEntityCLEICode, hwEntPowerUsedInfoEntry=hwEntPowerUsedInfoEntry, hwEntityExtVoltageLowThresholdNotification=hwEntityExtVoltageLowThresholdNotification, hwFanStatusGroup=hwFanStatusGroup, HWLevelState=HWLevelState, hwDisposeEntPhysicalIndex=hwDisposeEntPhysicalIndex, hwEntityUpTime=hwEntityUpTime, hwEntityCpuMaxUsage=hwEntityCpuMaxUsage, hwRUModuleInfoEntry=hwRUModuleInfoEntry, hwHeartbeatObjects=hwHeartbeatObjects, hwPortBip8StatisticsEntry=hwPortBip8StatisticsEntry, hwEntityOpticalRxHighWarnThreshold=hwEntityOpticalRxHighWarnThreshold, hwEntityMemSize=hwEntityMemSize, hwEntityVolRequired=hwEntityVolRequired, hwEntitySystemNetID=hwEntitySystemNetID, hwEntityTempMinorAlmThreshold=hwEntityTempMinorAlmThreshold, hwEntityOpticalTransBW=hwEntityOpticalTransBW, hwEntityExtMemUsageThresholdNotification=hwEntityExtMemUsageThresholdNotification, hwMonitorOutputGroup=hwMonitorOutputGroup, hwEntitySystemNEId=hwEntitySystemNEId, hwEntityOpenBomId=hwEntityOpenBomId, hwDevicePowerInfoUsedPower=hwDevicePowerInfoUsedPower, hwNseOpmStatus=hwNseOpmStatus, hwMonitorInputIndex=hwMonitorInputIndex, hwEntityDuplex=hwEntityDuplex, hwEntityFanSpeed=hwEntityFanSpeed, hwEntityFanState=hwEntityFanState, hwHeartbeatGroup=hwHeartbeatGroup, hwPnpGroup=hwPnpGroup, hwFileGeneIndex=hwFileGeneIndex, hwEntPowerUsedInfoGroup=hwEntPowerUsedInfoGroup, HwStandbyStatus=HwStandbyStatus, hwPortBip8StatisticsTable=hwPortBip8StatisticsTable, hwEntityTempValue=hwEntityTempValue, hwFileGeneOperState=hwFileGeneOperState, hwDisposeEntPhysicalContainedIn=hwDisposeEntPhysicalContainedIn, hwEntityBomLocalDesc=hwEntityBomLocalDesc, hwEntityFlashSize=hwEntityFlashSize, hwEntityExtOperEnabled=hwEntityExtOperEnabled, hwTemperatureThresholdGroup=hwTemperatureThresholdGroup, hwVirtualCableTestPairAStatus=hwVirtualCableTestPairAStatus, hwEntityTempSlotId=hwEntityTempSlotId, hwVirtualCableTestPairLength=hwVirtualCableTestPairLength, hwVirtualCableTestIfIndex=hwVirtualCableTestIfIndex, hwEntityAdminStatus=hwEntityAdminStatus, hwDisposeEntPhysicalParentRelPos=hwDisposeEntPhysicalParentRelPos, hwPnpInfo=hwPnpInfo, hwOpticalModuleInfoTable=hwOpticalModuleInfoTable, hwEntityTempMajorAlmThreshold=hwEntityTempMajorAlmThreshold, hwMonitorOutputEntry=hwMonitorOutputEntry, hwPreDisposedTraps=hwPreDisposedTraps, hwMonitorInputState=hwMonitorInputState, hwEntityExtObjects=hwEntityExtObjects, hwMonitorOutputKey=hwMonitorOutputKey, hwEntityExtOperDisabled=hwEntityExtOperDisabled, hwFileGeneResourceID=hwFileGeneResourceID, hwEntityOpticalType=hwEntityOpticalType, hwEntityOpticalWaveLength=hwEntityOpticalWaveLength, hwEntityOpticalTxHighWarnThreshold=hwEntityOpticalTxHighWarnThreshold, hwVirtualCableTestPairBStatus=hwVirtualCableTestPairBStatus, hwEntityVoltageHighThreshold=hwEntityVoltageHighThreshold, hwPhysicalPortBip8StatisticsUAS=hwPhysicalPortBip8StatisticsUAS, hwHardwareCapaChangeNotification=hwHardwareCapaChangeNotification, hwVirtualCableTestGroup=hwVirtualCableTestGroup, hwEntitySystemReset=hwEntitySystemReset, hwEntityMemUsageThreshold=hwEntityMemUsageThreshold, hwEntitySystemHealthInterval=hwEntitySystemHealthInterval, HwAdminState=HwAdminState, hwVirtualCableTestPairCLength=hwVirtualCableTestPairCLength, hwEntPowerUsedInfoBoardName=hwEntPowerUsedInfoBoardName, hwEntityHeartbeatOnOff=hwEntityHeartbeatOnOff, hwEntityFanReg=hwEntityFanReg, hwPreDisposeInfo=hwPreDisposeInfo, hwEntityStateEntry=hwEntityStateEntry, hwDevicePowerInfoTotalPower=hwDevicePowerInfoTotalPower, hwOpticalModuleInfoGroup=hwOpticalModuleInfoGroup, hwEntityTempI2CId=hwEntityTempI2CId, hwEntitySoftwareName=hwEntitySoftwareName, hwEntityVolChannel=hwEntityVolChannel, hwEntityOpticalFiberType=hwEntityOpticalFiberType, hwDisposeCardId=hwDisposeCardId, hwPhysicalPortBip8StatisticsBBE=hwPhysicalPortBip8StatisticsBBE, hwEntityVolAddr=hwEntityVolAddr, hwEntityTemperature=hwEntityTemperature, hwEntityIfUpTimes=hwEntityIfUpTimes, hwEntityServiceType=hwEntityServiceType, hwEntityCpuFrequency=hwEntityCpuFrequency, hwEntityIssueNum=hwEntityIssueNum, hwEntityExtentMIB=hwEntityExtentMIB, hwPhysicalPortSpeed=hwPhysicalPortSpeed, hwVirtualCableTestLastTime=hwVirtualCableTestLastTime, hwPnpTraps=hwPnpTraps, hwEntityCurrent=hwEntityCurrent, hwSystemGlobalObjects=hwSystemGlobalObjects, hwDisposeRowStatus=hwDisposeRowStatus, hwMonitorOutputMask=hwMonitorOutputMask, hwTemperatureThresholdTable=hwTemperatureThresholdTable, hwEntityVolHighAlmMajor=hwEntityVolHighAlmMajor, hwEntityOpticalVoltage=hwEntityOpticalVoltage, hwMonitorInputGroup=hwMonitorInputGroup, hwDevicePowerInfoGroup=hwDevicePowerInfoGroup, hwPortBip8StatisticsObjectGroup=hwPortBip8StatisticsObjectGroup, hwEntityBomId=hwEntityBomId, hwEntitySystemTime=hwEntitySystemTime, hwMonitorOutputIndex=hwMonitorOutputIndex, hwDisposeSbom=hwDisposeSbom, hwVirtualCableTestPairDStatus=hwVirtualCableTestPairDStatus, hwPreDisposeConfigTable=hwPreDisposeConfigTable, hwEntityExtMonitorPortNormalNotification=hwEntityExtMonitorPortNormalNotification, hwEntityVoltageLowThreshold=hwEntityVoltageLowThreshold, hwEntityFanSlot=hwEntityFanSlot, hwPreDisposeEntInfoEntry=hwPreDisposeEntInfoEntry, HwOperState=HwOperState, hwDisposeEntPhysicalClass=hwDisposeEntPhysicalClass, hwRUModuleInfoGroup=hwRUModuleInfoGroup, PYSNMP_MODULE_ID=hwEntityExtentMIB, hwVirtualCableTestPairBLength=hwVirtualCableTestPairBLength, hwDisposeEntPhysicalName=hwDisposeEntPhysicalName, hwEntityManufactureCode=hwEntityManufactureCode, hwPnpObjects=hwPnpObjects, hwEntityUpdateLog=hwEntityUpdateLog, HwAlarmStatus=HwAlarmStatus, hwEntityOpticalDirectionType=hwEntityOpticalDirectionType, hwEntityOpticalBiasCurrent=hwEntityOpticalBiasCurrent, hwFileGeneDestinationFile=hwFileGeneDestinationFile, hwMonitorInputName=hwMonitorInputName, hwEntityFanSn=hwEntityFanSn, hwEntityExtMonitorBoardNormalNotification=hwEntityExtMonitorBoardNormalNotification, hwEntityExtCompliances=hwEntityExtCompliances, hwEntitySystemMacAddress=hwEntitySystemMacAddress, hwOpticalModuleInfoEntry=hwOpticalModuleInfoEntry, hwEntPowerUsedInfoTable=hwEntPowerUsedInfoTable, hwDisposeEntPhysicalDescr=hwDisposeEntPhysicalDescr, hwEntityExtTemperatureThresholdNotification=hwEntityExtTemperatureThresholdNotification, hwEntityAlarmLight=hwEntityAlarmLight, hwEntityOpticalTemperature=hwEntityOpticalTemperature, hwEntityExtCpuUsageThresholdNotfication=hwEntityExtCpuUsageThresholdNotfication, hwEntityVolLowAlmFatal=hwEntityVolLowAlmFatal, hwFanStatusTable=hwFanStatusTable, hwPredisposeGroup=hwPredisposeGroup, hwEntityOperStatus=hwEntityOperStatus, hwPreDisposeObjects=hwPreDisposeObjects, hwEntityTemperatureThreshold=hwEntityTemperatureThreshold, hwEntityIfDownTimes=hwEntityIfDownTimes, hwEntityState=hwEntityState, hwEntityBoardType=hwEntityBoardType, hwPhysicalPortBip8StatisticsSES=hwPhysicalPortBip8StatisticsSES, hwEntityMemoryType=hwEntityMemoryType, hwEntityTempFatalAlmThreshold=hwEntityTempFatalAlmThreshold, hwFileGeneResourceType=hwFileGeneResourceType, hwMonitorOutputRuleIndex=hwMonitorOutputRuleIndex, hwEntityManufacturedDate=hwEntityManufacturedDate, hwEntityExtOldObjectsGroup=hwEntityExtOldObjectsGroup, hwEntitySoftwareVendor=hwEntitySoftwareVendor, hwHeartbeatConfig=hwHeartbeatConfig, hwEntityOpticalMode=hwEntityOpticalMode, hwEntityOpticalRxHighThreshold=hwEntityOpticalRxHighThreshold, hwVirtualCableTestEntry=hwVirtualCableTestEntry, hwEntitySoftwareVersion=hwEntitySoftwareVersion, hwHeartbeatTrapPrefix=hwHeartbeatTrapPrefix, hwEntityVolCurValue=hwEntityVolCurValue, hwEntityOpticalRxPower=hwEntityOpticalRxPower, hwEntityOpticalTxHighThreshold=hwEntityOpticalTxHighThreshold, hwEntityOpticalPlug=hwEntityOpticalPlug, hwMonitorInputEntry=hwMonitorInputEntry, hwEntityStandbyStatus=hwEntityStandbyStatus, hwTemperatureThresholdEntry=hwTemperatureThresholdEntry, hwPreDisposeConfigEntry=hwPreDisposeConfigEntry, hwEntityTempStatus=hwEntityTempStatus, hwInsertDiffFromPreDisposed=hwInsertDiffFromPreDisposed, hwEntityTemperatureLowThreshold=hwEntityTemperatureLowThreshold, hwEntityFanPresent=hwEntityFanPresent, hwEntityVolI2CId=hwEntityVolI2CId, hwEntityExtGroup=hwEntityExtGroup, hwEntityVolLowAlmMajor=hwEntityVolLowAlmMajor, hwEntityExtVoltageHighThresholdNotification=hwEntityExtVoltageHighThresholdNotification, hwEntityCPUAvgUsage=hwEntityCPUAvgUsage, hwEntityExtConformance=hwEntityExtConformance, hwEntityOpticalVendorSn=hwEntityOpticalVendorSn, hwEntityFanSpdAdjMode=hwEntityFanSpdAdjMode, hwSystemGlobalGroup=hwSystemGlobalGroup, hwPreDisposedChangeNotification=hwPreDisposedChangeNotification, hwEntityMemUsage=hwEntityMemUsage, hwEntityExtMonitorPortAbnormalNotification=hwEntityExtMonitorPortAbnormalNotification, hwEntityVoltage=hwEntityVoltage, hwEntityCpuUsage=hwEntityCpuUsage, hwEntityOpticalTxLowWarnThreshold=hwEntityOpticalTxLowWarnThreshold, hwMonitorInputRowStatus=hwMonitorInputRowStatus, hwMonitorOutputRowStatus=hwMonitorOutputRowStatus, hwEntityVolStatus=hwEntityVolStatus, hwEntityExtGroups=hwEntityExtGroups, hwHardwareCapaSequenceNo=hwHardwareCapaSequenceNo, hwEntPowerUsedInfoBoardSlot=hwEntPowerUsedInfoBoardSlot, hwFileGeneRowStatus=hwFileGeneRowStatus, hwDisposeEntPhysicalVendorType=hwDisposeEntPhysicalVendorType, hwVirtualCableTestPairALength=hwVirtualCableTestPairALength, hwVirtualCableTestPairStatus=hwVirtualCableTestPairStatus, hwPnpOperateTable=hwPnpOperateTable, hwDevicePowerInfoObjects=hwDevicePowerInfoObjects, hwEntityPortType=hwEntityPortType, hwEntityTempAddr=hwEntityTempAddr, hwMonitorOutputTable=hwMonitorOutputTable, hwEntityExtCompliance=hwEntityExtCompliance, hwPreDisposeSequenceNo=hwPreDisposeSequenceNo, hwEntityOpticalTxPower=hwEntityOpticalTxPower, hwEntityBoardClass=hwEntityBoardClass, hwEntityMemSizeMega=hwEntityMemSizeMega, hwEntityExtTraps=hwEntityExtTraps, hwVoltageInfoGroup=hwVoltageInfoGroup, hwVirtualCableTestPairCStatus=hwVirtualCableTestPairCStatus, hwPreDisposeEntInfoTable=hwPreDisposeEntInfoTable, hwEntityVolRatio=hwEntityVolRatio, hwEntityHeartbeatPeriod=hwEntityHeartbeatPeriod, hwEntityHeartbeatTrap=hwEntityHeartbeatTrap, hwEntPowerUsedInfoPower=hwEntPowerUsedInfoPower, hwEntityCPUType=hwEntityCPUType, hwVirtualCableTestPairDLength=hwVirtualCableTestPairDLength, hwEntityArchivesInfoVersion=hwEntityArchivesInfoVersion, hwEntitySupportFlexCard=hwEntitySupportFlexCard, hwPnpOperateEntry=hwPnpOperateEntry, hwDisposeOperState=hwDisposeOperState, hwEntityVolHighAlmFatal=hwEntityVolHighAlmFatal, hwEntitySystemModel=hwEntitySystemModel, hwEntityOpticalPower=hwEntityOpticalPower, hwRUModuleInfoTable=hwRUModuleInfoTable, hwEntityOpticalTxLowThreshold=hwEntityOpticalTxLowThreshold, hwVirtualCableTestTable=hwVirtualCableTestTable, hwVirtualCableTestOperation=hwVirtualCableTestOperation, hwVoltageInfoTable=hwVoltageInfoTable, hwEntityOpticalPowerRx=hwEntityOpticalPowerRx, hwEntPowerUsedInfoBoardType=hwEntPowerUsedInfoBoardType, hwMonitorInputStateEnable=hwMonitorInputStateEnable, hwEntityExtMonitorBoardAbnormalNotification=hwEntityExtMonitorBoardAbnormalNotification, hwMonitorInputTable=hwMonitorInputTable, hwEntityTempChannel=hwEntityTempChannel, hwEntityOpticalUserEeprom=hwEntityOpticalUserEeprom, hwEntityOpticalRxLowThreshold=hwEntityOpticalRxLowThreshold, hwEntityStateTable=hwEntityStateTable, hwFanStatusEntry=hwFanStatusEntry)
mibBuilder.exportSymbols("HUAWEI-ENTITY-EXTENT-MIB", hwVoltageInfoEntry=hwVoltageInfoEntry)
