...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/HUAWEI-DEVICE-MIB
# Produced by pysmi-0.3.4 at Thu Jun 20 22:21:05 2019
...
HWPortType, HWPCBType, HWSubPCBType, HWFrameType = mibBuilder.importSymbols("HUAWEI-TC-MIB", "HWPortType", "HWPCBType", "HWSubPCBType", "HWFrameType")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, MibIdentifier, ObjectIdentity, ModuleIdentity, NotificationType, Integer32, Counter32, Gauge32, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Integer32", "Counter32", "Gauge32", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("HUAWEI-DEVICE-MIB", hwMemoryDevFailNoMem=hwMemoryDevFailNoMem, hwFrameIndex=hwFrameIndex, hwSysIpMask=hwSysIpMask, hwSlots=hwSlots, hwSlotDesc=hwSlotDesc, hwNmsStatus=hwNmsStatus, hwDevTrapVbOids=hwDevTrapVbOids, hwSlotAdminStatus=hwSlotAdminStatus, hwFrameTable=hwFrameTable, hwBufferCurrentTotal=hwBufferCurrentTotal, hwPortSpeed=hwPortSpeed, hwDevTraps=hwDevTraps, hwAvgDuty5min=hwAvgDuty5min, trapObjectIdValue=trapObjectIdValue, hwMemoryDevRawSliceUsed=hwMemoryDevRawSliceUsed, hwCliUserLogins=hwCliUserLogins, hwCliUserDecr=hwCliUserDecr, hwNmsSnmpPort=hwNmsSnmpPort, hwCliClientIp=hwCliClientIp, hwBufferCurrentUsed=hwBufferCurrentUsed, hwBoardAulaw=hwBoardAulaw, hwMemoryDevLargestFree=hwMemoryDevLargestFree, hwFrameLinkEntry=hwFrameLinkEntry, hwFrameLinkRightSubSlot=hwFrameLinkRightSubSlot, hwFrameAdminResultTrap=hwFrameAdminResultTrap, hwNmsMaintainMode=hwNmsMaintainMode, hwCpuDevTable=hwCpuDevTable, hwAlarmInfo=hwAlarmInfo, hwSubSlots=hwSubSlots, hwPortAdminStatus=hwPortAdminStatus, hwCpuDevDuty=hwCpuDevDuty, hwBoardAttrTable=hwBoardAttrTable, hwCliUserRowStatus=hwCliUserRowStatus, hwNmsGetCommunity=hwNmsGetCommunity, hwAlarmOcurTime=hwAlarmOcurTime, hwSlotConf=hwSlotConf, PYSNMP_MODULE_ID=hwDev, hwMemoryDevModuleIndex=hwMemoryDevModuleIndex, hwFlashDevTable=hwFlashDevTable, hwNmsParaTable=hwNmsParaTable, hwCpuDevIndex=hwCpuDevIndex, hwCompatibleSysOid=hwCompatibleSysOid, hwSysVersion=hwSysVersion, hwCliUserMgmt=hwCliUserMgmt, hwFlashDevEraseStatus=hwFlashDevEraseStatus, hwAlarmSerialIndex=hwAlarmSerialIndex, hwPortTable=hwPortTable, hwSubslotType=hwSubslotType, hwMemoryDevFree=hwMemoryDevFree, hwDevGeneralTraps=hwDevGeneralTraps, hwDev=hwDev, hwNmsIp=hwNmsIp, hwFrameLinkLeftSlot=hwFrameLinkLeftSlot, hwBoardAttrEntry=hwBoardAttrEntry, hwSubSlotAdminResultTrap=hwSubSlotAdminResultTrap, hwNmsIndex=hwNmsIndex, hwCompatibleVRCB=hwCompatibleVRCB, hwNmsParaEntry=hwNmsParaEntry, hwCliClientType=hwCliClientType, hwSubslotPorts=hwSubslotPorts, hwDevCompatibleTable=hwDevCompatibleTable, hwSubslotIndex=hwSubslotIndex, hwSysIpAddr=hwSysIpAddr, hwSubslotTable=hwSubslotTable, hwPortIndex=hwPortIndex, hwPortOperStatus=hwPortOperStatus, hwPortType=hwPortType, hwFlashDevStatus=hwFlashDevStatus, hwSlotIndex=hwSlotIndex, hwSubSlotDesc=hwSubSlotDesc, hwFrameLinkNumber=hwFrameLinkNumber, hwMemoryDev=hwMemoryDev, hwSlotVersion=hwSlotVersion, hwBufferModuleIndex=hwBufferModuleIndex, hwAlarmTable=hwAlarmTable, hwFrameLinkRightPort=hwFrameLinkRightPort, hwSlotAdminResultTrap=hwSlotAdminResultTrap, hwSubslotAdminStatus=hwSubslotAdminStatus, hwCliClientAdminStatus=hwCliClientAdminStatus, hwFrameLinkRightFrame=hwFrameLinkRightFrame, hwFrameDesc=hwFrameDesc, hwCliUserName=hwCliUserName, hwFlashDevEntry=hwFlashDevEntry, hwSubslotVersion=hwSubslotVersion, hwNmsName=hwNmsName, hwFrameOperStatus=hwFrameOperStatus, hwAvgDuty1min=hwAvgDuty1min, hwFlashDevEraseTime=hwFlashDevEraseTime, hwSlotRowStatus=hwSlotRowStatus, hwNarrowBoard=hwNarrowBoard, hwFrameAdminStatus=hwFrameAdminStatus, hwMemoryDevSize=hwMemoryDevSize, hwCliClientTable=hwCliClientTable, hwMemoryDevFail=hwMemoryDevFail, hwMemoryDevTable=hwMemoryDevTable, hwFrameLinkIndex=hwFrameLinkIndex, hwAlarmType=hwAlarmType, hwFrameLinkRightSlot=hwFrameLinkRightSlot, hwFrameRowStatus=hwFrameRowStatus, hwBufferEntry=hwBufferEntry, hwCliUserPassword=hwCliUserPassword, hwNmsTrapPort=hwNmsTrapPort, hwPortAdminResult=hwPortAdminResult, hwCliUserParaTable=hwCliUserParaTable, hwSlotPcbVersion=hwSlotPcbVersion, hwAlarmEntry=hwAlarmEntry, hwFrameLinkTable=hwFrameLinkTable, hwFlashDev=hwFlashDev, hwFrameLinkLeftSubSlot=hwFrameLinkLeftSubSlot, hwNmsSetCommunity=hwNmsSetCommunity, hwSlotEntry=hwSlotEntry, hwFlashDevFree=hwFlashDevFree, hwSlotAdminResult=hwSlotAdminResult, hwSubslotOperStatus=hwSubslotOperStatus, hwCliUserParaEntry=hwCliUserParaEntry, hwBoardCurrent=hwBoardCurrent, hwFrameLinkRowStatus=hwFrameLinkRowStatus, hwSlotType=hwSlotType, hwFrameLinkLeftFrame=hwFrameLinkLeftFrame, hwCliClientUserName=hwCliClientUserName, hwSubslotAdminResult=hwSubslotAdminResult, hwSlotOperStatus=hwSlotOperStatus, hwSysTime=hwSysTime, hwSlotTable=hwSlotTable, hwCpuDevEntry=hwCpuDevEntry, hwFlashDevIndex=hwFlashDevIndex, hwFrameLinkLeftPort=hwFrameLinkLeftPort, hwCliClientID=hwCliClientID, hwFrameLinks=hwFrameLinks, hwCliClientLoginTime=hwCliClientLoginTime, hwSystemPara=hwSystemPara, hwMemoryDevEntry=hwMemoryDevEntry, hwSubslotRowStatus=hwSubslotRowStatus, hwCompatibleVersion=hwCompatibleVersion, hwBoardImpedance=hwBoardImpedance, hwFrameEntry=hwFrameEntry, hwPortAdminResultTrap=hwPortAdminResultTrap, hwSlotWorkMode=hwSlotWorkMode, hwPortEntry=hwPortEntry, hwCompatibleProductName=hwCompatibleProductName, hwBufferSize=hwBufferSize, hwFlashDevSize=hwFlashDevSize, hwSubslotEntry=hwSubslotEntry, hwFrameLinkNextIndex=hwFrameLinkNextIndex, hwCliUserLevel=hwCliUserLevel, hwCliClientEntry=hwCliClientEntry, hwNmsClass=hwNmsClass, hwBufferTable=hwBufferTable, hwFrameType=hwFrameType, hwFrameLinkOperStatus=hwFrameLinkOperStatus, hwFrameAdminResult=hwFrameAdminResult, hwNmsMask=hwNmsMask, hwPortDesc=hwPortDesc, hwSlotPhySerialNum=hwSlotPhySerialNum)
