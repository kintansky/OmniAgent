...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/HUAWEI-IF-EXT-MIB
...
ifIndex, ifName, InterfaceIndexOrZero, ifAdminStatus, ifDescr, InterfaceIndex, ifOperStatus = mibBuilder.importSymbols("IF-MIB", "ifIndex", "ifName", "InterfaceIndexOrZero", "ifAdminStatus", "ifDescr", "InterfaceIndex", "ifOperStatus")
...
iso, Bits, IpAddress, Counter64, NotificationType, ObjectIdentity, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Integer32, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "IpAddress", "Counter64", "NotificationType", "ObjectIdentity", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Integer32", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("HUAWEI-IF-EXT-MIB", hwIfMonitorPauseFrameThreshold=hwIfMonitorPauseFrameThreshold, hwVTrunkMemEntry=hwVTrunkMemEntry, hwLendIfIndex=hwLendIfIndex, hwIfMonitorSdhErrorThreshold=hwIfMonitorSdhErrorThreshold, hwTrunkIfBackupPreemptEnable=hwTrunkIfBackupPreemptEnable, hwLogicDynamicIfTotal=hwLogicDynamicIfTotal, hwAdminVrrpMemberIf=hwAdminVrrpMemberIf, hwVTrunkMemAttr=hwVTrunkMemAttr, hwCppsIfStatisticsTable=hwCppsIfStatisticsTable, hwTrunkIsDefaultLagRecv=hwTrunkIsDefaultLagRecv, hwLogicIfAttrGroup=hwLogicIfAttrGroup, hwCppsPortIndex=hwCppsPortIndex, hwIfMonitorSdhEnabledStatus=hwIfMonitorSdhEnabledStatus, hwIfMonitorGeneral=hwIfMonitorGeneral, hwIfMonitorSdhErrorResume=hwIfMonitorSdhErrorResume, hwTrunkPortWeight=hwTrunkPortWeight, hwIfEtherStatOutExcessiveCollisionPkts=hwIfEtherStatOutExcessiveCollisionPkts, hwIpAdEntNetMask=hwIpAdEntNetMask, hwIfControlFlapSuppress=hwIfControlFlapSuppress, hwCppsInterfaceIndex=hwCppsInterfaceIndex, hwLogicIfIndex=hwLogicIfIndex, hwTrunkIfRowStatus=hwTrunkIfRowStatus, hwIfEtherStatOutDeferredPkts=hwIfEtherStatOutDeferredPkts, hwEntityExtCfmOverCard=hwEntityExtCfmOverCard, hwTrunkIfPreemptEnable=hwTrunkIfPreemptEnable, hwTrunkETrunkSysID=hwTrunkETrunkSysID, hwTrunkUnknownUnicastIfModel=hwTrunkUnknownUnicastIfModel, hwIfMonitorBadBytesErrorThreshold=hwIfMonitorBadBytesErrorThreshold, hwExtAllMemberDownNotify=hwExtAllMemberDownNotify, hwIfEtherStatInJabberPkts=hwIfEtherStatInJabberPkts, hwTrunkIfBackupPreemptDelay=hwTrunkIfBackupPreemptDelay, hwSubInterfaceBackupTrunkGroup=hwSubInterfaceBackupTrunkGroup, hwVTrunkIfIndex=hwVTrunkIfIndex, PYSNMP_MODULE_ID=hwIFExtMib, hwTrunkIfTimeoutReceive=hwTrunkIfTimeoutReceive, hwIfIpAddressGroup=hwIfIpAddressGroup, hwTrunkIfTrackVrrpIfIndex=hwTrunkIfTrackVrrpIfIndex, hwIfSdhIfStatReset=hwIfSdhIfStatReset, hwIFExtBase=hwIFExtBase, hwAdminVrrpMemberIfFlowStatus=hwAdminVrrpMemberIfFlowStatus, hwLogicIfHelpTable=hwLogicIfHelpTable, hwIfMonitorSdhB1ErrorThreshold=hwIfMonitorSdhB1ErrorThreshold, hwAdminVrrpMemberIfTable=hwAdminVrrpMemberIfTable, hwTrunkSubIfStateToMaster=hwTrunkSubIfStateToMaster, hwVTrunkIfEntry=hwVTrunkIfEntry, hwIfMonitorHalfDuplexEnabledStatus=hwIfMonitorHalfDuplexEnabledStatus, hwAdminVrrpIfIndex=hwAdminVrrpIfIndex, hwIfMonitorSymbolErrorResume=hwIfMonitorSymbolErrorResume, hwTrunkPortPriority=hwTrunkPortPriority, hwIfFlowDown=hwIfFlowDown, hwIfPortControlDown=hwIfPortControlDown, hwFlushVlanId=hwFlushVlanId, hwAdminVrrpVrid=hwAdminVrrpVrid, hwTrunkMemEntry=hwTrunkMemEntry, hwIfMonitorOutputRateThreshold=hwIfMonitorOutputRateThreshold, hwTrunkIfTrackVrrpReset=hwTrunkIfTrackVrrpReset, hwIfMonitorSdhB1ErrorStatistics=hwIfMonitorSdhB1ErrorStatistics, hwTrunkETrunkSystemPriority=hwTrunkETrunkSystemPriority, hwIfEtherStatIfIndex=hwIfEtherStatIfIndex, hwCppsPortVlanTable=hwCppsPortVlanTable, hwIfMonitorGeneralGroup=hwIfMonitorGeneralGroup, hwIfSdhStatEntry=hwIfSdhStatEntry, hwTrunkIfLagMaxActiveLinkNum=hwTrunkIfLagMaxActiveLinkNum, hwIfMonitorName=hwIfMonitorName, hwTrunkIfAutoRecover=hwTrunkIfAutoRecover, hwIfMonitorBadBytesErrorStatistics=hwIfMonitorBadBytesErrorStatistics, hwTrunkIfLagSelectedPortStd=hwTrunkIfLagSelectedPortStd, hwIfFluxIfIndex=hwIfFluxIfIndex, hwIfMonitorObject=hwIfMonitorObject, hwIpAdEntIfIndex=hwIpAdEntIfIndex, hwTrunkIfEntry=hwTrunkIfEntry, hwIfDiffServTable=hwIfDiffServTable, hwIfEtherStatOutJumboPkts=hwIfEtherStatOutJumboPkts, hwLacpNegotiateFailed=hwLacpNegotiateFailed, hwCppsPortVlanGroup=hwCppsPortVlanGroup, hwIfMonitorThresholdEntry=hwIfMonitorThresholdEntry, hwVTrunkValidEntry=hwVTrunkValidEntry, hwTrunkMemifIndex=hwTrunkMemifIndex, hwIfMonitorPauseFrameRisingResume=hwIfMonitorPauseFrameRisingResume, hwRevertiveMode=hwRevertiveMode, hwCppsAtmPvcByteStatisic=hwCppsAtmPvcByteStatisic, hwLogicIfName=hwLogicIfName, hwIfEtherStatEntry=hwIfEtherStatEntry, hwIfEtherStatInOverRunPkts=hwIfEtherStatInOverRunPkts, hwVTrunkIfTable=hwVTrunkIfTable, hwVTrunkPortActive=hwVTrunkPortActive, hwIfControlFlapResume=hwIfControlFlapResume, hwMonitorTrapGroup=hwMonitorTrapGroup, hwVTrunkMemTable=hwVTrunkMemTable, hwIfMonitorCrcErrorStatistics=hwIfMonitorCrcErrorStatistics, hwVTrunkIfnetIndex=hwVTrunkIfnetIndex, hwIfEtherStatInUnderSizePkts=hwIfEtherStatInUnderSizePkts, hwExtLinkUp=hwExtLinkUp, hwIFExtFlushVlanId=hwIFExtFlushVlanId, hwIfFluxLimitType=hwIfFluxLimitType, hwIFExtConformance=hwIFExtConformance, hwLogicIfAttrib=hwLogicIfAttrib, hwIpAdEntReasmMaxSize=hwIpAdEntReasmMaxSize, hwIfEtherStatInPkts256to511Octets=hwIfEtherStatInPkts256to511Octets, hwAdminVrrpMemberIfIndex=hwAdminVrrpMemberIfIndex, hwCppsAtmPvcTable=hwCppsAtmPvcTable, hwIpAdEntAddressType=hwIpAdEntAddressType, hwCppsInterfaceGroup=hwCppsInterfaceGroup, hwIfAtmStatInGoodCells=hwIfAtmStatInGoodCells, hwIfMonitorSymbolErrorStatistics=hwIfMonitorSymbolErrorStatistics, hwCppsGlobalEnableGroup=hwCppsGlobalEnableGroup, hwLoopbackBlock=hwLoopbackBlock, hwTrunkPortStatReset=hwTrunkPortStatReset, hwIFExtTraps=hwIFExtTraps, hwVaspPortName=hwVaspPortName, hwIfMonitorSdhB2ErrorRising=hwIfMonitorSdhB2ErrorRising, hwCppsInterfacePktStatisic=hwCppsInterfacePktStatisic, hwCppsInterfaceByteStatisic=hwCppsInterfaceByteStatisic, hwVTrunkOperstatus=hwVTrunkOperstatus, hwIFFlowStatGroup=hwIFFlowStatGroup, hwTrunkLocalPrefMode=hwTrunkLocalPrefMode, hwTrunkWorkingSwitch=hwTrunkWorkingSwitch, hwLendIpAddrNetMask=hwLendIpAddrNetMask, hwLogicIfType=hwLogicIfType, hwTrunkIfTable=hwTrunkIfTable, hwTrunkMemAttr=hwTrunkMemAttr, hwIfMonitorBadBytesErrorResume=hwIfMonitorBadBytesErrorResume, hwIfMonitorHalfDuplexRising=hwIfMonitorHalfDuplexRising, hwIfQueryGroup=hwIfQueryGroup, hwLacpPartialLinkLoss=hwLacpPartialLinkLoss, hwMasterBackupTrunkSubinterfaceAttr=hwMasterBackupTrunkSubinterfaceAttr, hwTrunkValidEntry=hwTrunkValidEntry, hwCppsIfStatisticsEntry=hwCppsIfStatisticsEntry, hwIfEtherStatInPkts64Octets=hwIfEtherStatInPkts64Octets, hwVTrunkIfGroup=hwVTrunkIfGroup, hwIfEtherStatInCRCPkts=hwIfEtherStatInCRCPkts, hwVTrunkAttr=hwVTrunkAttr, hwPortIsolationGroupRowStatus=hwPortIsolationGroupRowStatus, hwTrunkLacpStatus=hwTrunkLacpStatus, hwCppsGlobalEnable=hwCppsGlobalEnable, hwIFExtFrameType=hwIFExtFrameType, hwCppsPortVlanEntry=hwCppsPortVlanEntry, hwLogicIfMax=hwLogicIfMax, hwIFExtLayer=hwIFExtLayer, hwIFFlowStatGlobalInterval=hwIFFlowStatGlobalInterval, hwIfFluxRowStatus=hwIfFluxRowStatus, hwTrunkMemGroup=hwTrunkMemGroup, hwIfIpUnnumberedTable=hwIfIpUnnumberedTable, hwPortIsolationGroupTable=hwPortIsolationGroupTable, hwIfEtherStatInPausePkts=hwIfEtherStatInPausePkts, hwIpAdEntAddr=hwIpAdEntAddr, hwIfDiffServGroup=hwIfDiffServGroup, hwCppsIfStatisticsIndex=hwCppsIfStatisticsIndex, hwTrunkIfID=hwTrunkIfID, hwTrunkIfForceSwitchEnable=hwTrunkIfForceSwitchEnable, hwTrunkIfWorkingState=hwTrunkIfWorkingState, hwIfSdhStatInShortPkts=hwIfSdhStatInShortPkts, hwIfMonitorSdhB1ErrorRising=hwIfMonitorSdhB1ErrorRising, hwIfEtherStatInPkts65to127Octets=hwIfEtherStatInPkts65to127Octets, hwLogicIfParaOne=hwLogicIfParaOne, hwTrunkIfModel=hwTrunkIfModel, hwTrunkBandwidth=hwTrunkBandwidth, hwTrunkIfPreemptDelay=hwTrunkIfPreemptDelay, hwIFExtMemberOf=hwIFExtMemberOf, hwNewIfTimeslot=hwNewIfTimeslot, hwIFExtTrapGroup=hwIFExtTrapGroup, hwIfMonitorOutputRatePercentage=hwIfMonitorOutputRatePercentage, hwLoopbackResume=hwLoopbackResume, hwIfMonitorSdhB1ErrorResume=hwIfMonitorSdhB1ErrorResume, hwInterfaceIp=hwInterfaceIp, hwIfMonitorSdhB2ErrorResume=hwIfMonitorSdhB2ErrorResume, hwIfEtherStatInPkts128to255Octets=hwIfEtherStatInPkts128to255Octets, hwLogicIfSlotNumber=hwLogicIfSlotNumber, hwTrunkIfBandWidthAffectLinkNum=hwTrunkIfBandWidthAffectLinkNum, hwIfMonitorSdhErrorStatistics=hwIfMonitorSdhErrorStatistics, hwIfEtherStatInAlignmentPkts=hwIfEtherStatInAlignmentPkts, hwIfQueryTable=hwIfQueryTable, hwLogicIfChassisNumber=hwLogicIfChassisNumber, hwTrunkIfType=hwTrunkIfType, hwTrunkSystemPriority=hwTrunkSystemPriority, hwIfEtherStatOutUnderRunPkts=hwIfEtherStatOutUnderRunPkts, hwIfEtherStatTable=hwIfEtherStatTable, hwIfAtmStatInCorrectedCells=hwIfAtmStatInCorrectedCells, hwCppsObjects=hwCppsObjects, hwIfSdhStatOutUnderRunPkts=hwIfSdhStatOutUnderRunPkts, hwIfEtherStatInSymbolPkts=hwIfEtherStatInSymbolPkts, hwIfFluxVlanId=hwIfFluxVlanId, hwLogicDynamicIfChassisNumber=hwLogicDynamicIfChassisNumber, hwEntityExtCfmOverSlot=hwEntityExtCfmOverSlot, hwIFExtTable=hwIFExtTable, hwCppsPortPvcEnable=hwCppsPortPvcEnable, hwTrunkIfIndex=hwTrunkIfIndex, hwIfAtmStatInUncorrectedCells=hwIfAtmStatInUncorrectedCells, SnmpPasswdString=SnmpPasswdString, hwIfPortControlUp=hwIfPortControlUp, hwMasterBackupTrunkSubinterfaceTable=hwMasterBackupTrunkSubinterfaceTable, hwIfMonitorInputRatePercentage=hwIfMonitorInputRatePercentage, hwLinkDownReason=hwLinkDownReason, hwIfMonitorOutputRateResume=hwIfMonitorOutputRateResume, hwIfIndex=hwIfIndex, hwLogicDynamicIfMax=hwLogicDynamicIfMax, hwVTrunkIfRowStatus=hwVTrunkIfRowStatus, hwCppsAtmIfIndex=hwCppsAtmIfIndex, hwIfDiffServColor=hwIfDiffServColor, hwLinkModeChangeAutoCreateIfEntry=hwLinkModeChangeAutoCreateIfEntry, hwIFExtFlowStatus=hwIFExtFlowStatus, hwTrunkDeleteFlag=hwTrunkDeleteFlag, hwIFExtObjects=hwIFExtObjects, hwIfMonitorDelayThreshold=hwIfMonitorDelayThreshold, hwTrunkIfFlushVlanId=hwTrunkIfFlushVlanId, hwIfMonitorSymbolErrorRising=hwIfMonitorSymbolErrorRising, hwPortIsolationGroupAttrib=hwPortIsolationGroupAttrib, hwLogicIfMainIndex=hwLogicIfMainIndex, hwIfFluxLimitGroup=hwIfFluxLimitGroup, hwTrunkIfTrackVrrpVrid=hwTrunkIfTrackVrrpVrid, hwIfMonitorPauseRisingEnabledStatus=hwIfMonitorPauseRisingEnabledStatus, hwLacpPartialLinkLossResume=hwLacpPartialLinkLossResume, hwExtAllMemberDownResume=hwExtAllMemberDownResume, hwTrunkPortStandby=hwTrunkPortStandby, hwIfSdhStatOutOverRunPkts=hwIfSdhStatOutOverRunPkts, hwIfMonitorCrcErrorInterval=hwIfMonitorCrcErrorInterval, hwIfMonitorInputRateThreshold=hwIfMonitorInputRateThreshold, hwLogicIfRowStatus=hwLogicIfRowStatus, hwIfIpTable=hwIfIpTable, hwIFExtMacAddr=hwIFExtMacAddr, hwIfEtherStatOutCollisionPkts=hwIfEtherStatOutCollisionPkts, hwIfEtherStatOutBufferPurgationPkts=hwIfEtherStatOutBufferPurgationPkts, hwCppsAtmPvcPktStatisic=hwCppsAtmPvcPktStatisic, hwCppsPortVlanEnable=hwCppsPortVlanEnable, hwIfFlowChangeTime=hwIfFlowChangeTime, hwLogicIfTotal=hwLogicIfTotal, hwCppsVlanId=hwCppsVlanId, hwCppsResetPortVlanStatisic=hwCppsResetPortVlanStatisic, hwIFExtFlushReceiveEnable=hwIFExtFlushReceiveEnable, hwIfSdhStatIfIndex=hwIfSdhStatIfIndex, hwIfIpEntry=hwIfIpEntry, hwIfIpMethod=hwIfIpMethod, hwIfFluxLimit=hwIfFluxLimit, hwIFExtEntry=hwIFExtEntry, hwCppsAtmVci=hwCppsAtmVci, hwCppsPortVlanByteStatisic=hwCppsPortVlanByteStatisic, hwTrunkSubIfStateToSlave=hwTrunkSubIfStateToSlave, hwVTrunkIfType=hwVTrunkIfType, hwIfMonitorPauseFrameRising=hwIfMonitorPauseFrameRising, hwIfMonitorBadBytesErrorInterval=hwIfMonitorBadBytesErrorInterval, hwIfMonitorThresholdTable=hwIfMonitorThresholdTable, hwLacpTotalLinkLoss=hwLacpTotalLinkLoss, hwIfAtmIfStatReset=hwIfAtmIfStatReset, HwIpAddressType=HwIpAddressType, hwIfMonitorSdhB1ErrorInterval=hwIfMonitorSdhB1ErrorInterval, hwIfMonitorCrcEnabledStatus=hwIfMonitorCrcEnabledStatus, hwMonitorNotifications=hwMonitorNotifications, hwIFExtIndex=hwIFExtIndex, hwTrunkETrunkSystemID=hwTrunkETrunkSystemID, hwIfMonitorInputRateEnabledStatus=hwIfMonitorInputRateEnabledStatus, hwVTrunkMemGroup=hwVTrunkMemGroup, hwIfAtmStatInIdleCells=hwIfAtmStatInIdleCells, hwAdminVrrpMemberIfRowStatus=hwAdminVrrpMemberIfRowStatus, hwIfEthIfStatReset=hwIfEthIfStatReset)
mibBuilder.exportSymbols("HUAWEI-IF-EXT-MIB", hwIfEtherStatOutPausePkts=hwIfEtherStatOutPausePkts, hwIfName=hwIfName, hwBackupTrunkIfIndex=hwBackupTrunkIfIndex, hwTrunkIfMax=hwTrunkIfMax, hwIfAtmStatEntry=hwIfAtmStatEntry, hwIfMonitorInputRateResume=hwIfMonitorInputRateResume, hwIFExtMtu=hwIFExtMtu, hwIFExtMacShift=hwIFExtMacShift, hwIfMonitorCrcErrorRising=hwIfMonitorCrcErrorRising, hwIfMonitorInputRateRising=hwIfMonitorInputRateRising, hwIfFluxCbs=hwIfFluxCbs, hwIfAtmStatOutIdleCells=hwIfAtmStatOutIdleCells, hwIfMonitorCrcErrorThreshold=hwIfMonitorCrcErrorThreshold, hwVTrunkMemIfIndex=hwVTrunkMemIfIndex, hwLogicIfDynamicHelpTableGroup=hwLogicIfDynamicHelpTableGroup, hwIpAdEntAddrStatus=hwIpAdEntAddrStatus, hwLogicDynamicIfhelpType=hwLogicDynamicIfhelpType, hwTrunkIfArpSendSpeed=hwTrunkIfArpSendSpeed, hwIFExtFlushPasswd=hwIFExtFlushPasswd, hwIFExtFlowStatInterval=hwIFExtFlowStatInterval, hwCppsResetInterfaceStatisic=hwCppsResetInterfaceStatisic, hwIFExtPhyNumber=hwIFExtPhyNumber, hwLinkModeChangeAutoCreateIfTable=hwLinkModeChangeAutoCreateIfTable, hwIfEtherStatInFramePkts=hwIfEtherStatInFramePkts, hwWtrTime=hwWtrTime, hwIfFluxLimitTable=hwIfFluxLimitTable, hwIfEtherStatInPkts512to1023Octets=hwIfEtherStatInPkts512to1023Octets, hwTrunkSelectStatus=hwTrunkSelectStatus, hwIfIpAddressChange=hwIfIpAddressChange, hwIfEtherStatInDropEventPkts=hwIfEtherStatInDropEventPkts, hwTrunkIfWorkingMode=hwTrunkIfWorkingMode, hwIfMonitorPauseFrameInterval=hwIfMonitorPauseFrameInterval, hwIfFlowUp=hwIfFlowUp, hwTrunkPortMaster=hwTrunkPortMaster, hwIfEtherStatGroup=hwIfEtherStatGroup, hwIfIpUnnumberedGroup=hwIfIpUnnumberedGroup, hwIFExtGroups=hwIFExtGroups, hwLogicIfMin=hwLogicIfMin, hwIfSdhStatTable=hwIfSdhStatTable, hwTrunkIndex=hwTrunkIndex, hwLogicIfhelpType=hwLogicIfhelpType, hwIfMonitorSdhB2ErrorInterval=hwIfMonitorSdhB2ErrorInterval, hwTrunkAttr=hwTrunkAttr, hwCppsInterfaceEntry=hwCppsInterfaceEntry, hwIfMonitorOutputRateEnabledStatus=hwIfMonitorOutputRateEnabledStatus, hwTrunkETrunkPriorityReset=hwTrunkETrunkPriorityReset, hwIfAtmStatIfIndex=hwIfAtmStatIfIndex, hwPortIsolationGroup=hwPortIsolationGroup, hwUnnumberedIfIndex=hwUnnumberedIfIndex, hwLogicIfEntry=hwLogicIfEntry, hwIfStatistics=hwIfStatistics, hwIfEtherStatOutLateCollisionPkts=hwIfEtherStatOutLateCollisionPkts, hwVTrunkIfID=hwVTrunkIfID, hwCppsAtmPvcEntry=hwCppsAtmPvcEntry, hwIFIpNotifications=hwIFIpNotifications, hwVaspPort=hwVaspPort, hwVaspPortPeerMacEntry=hwVaspPortPeerMacEntry, hwIfEtherStatInIgnoredPkts=hwIfEtherStatInIgnoredPkts, hwIFExtTrapObjects=hwIFExtTrapObjects, hwLogicIfCardNumber=hwLogicIfCardNumber, hwIfMonitorJitterThreshold=hwIfMonitorJitterThreshold, hwCppsInterfaceTable=hwCppsInterfaceTable, hwLogicIfDynamicHelpTable=hwLogicIfDynamicHelpTable, hwVaspPortPeerMacTable=hwVaspPortPeerMacTable, hwIfEtherStatInJumboPkts=hwIfEtherStatInJumboPkts, hwExtLinkDown=hwExtLinkDown, hwIfMonitorIndex=hwIfMonitorIndex, hwIFExtTrapGroups=hwIFExtTrapGroups, hwPortIsolationGroupPortList=hwPortIsolationGroupPortList, HWDirectionType=HWDirectionType, hwMainIfName=hwMainIfName, hwTrunkMemTable=hwTrunkMemTable, hwIfDiffServIndex=hwIfDiffServIndex, hwIFExtMib=hwIFExtMib, hwCfmOverPhysicalName=hwCfmOverPhysicalName, hwTrunkETrunkPriority=hwTrunkETrunkPriority, hwIfMonitorJitterValue=hwIfMonitorJitterValue, hwIFExtGroup=hwIFExtGroup, hwPortIsolationGroupIndex=hwPortIsolationGroupIndex, hwLacpTotalLinkLossResume=hwLacpTotalLinkLossResume, hwLogicDynamicIfMin=hwLogicDynamicIfMin, hwIfNameChange=hwIfNameChange, hwIfMonitorDelayValue=hwIfMonitorDelayValue, hwAdminVrrpMemberIfGroup=hwAdminVrrpMemberIfGroup, hwTrunkIfFlushSendEnable=hwTrunkIfFlushSendEnable, hwIfMonitorOutputRateRising=hwIfMonitorOutputRateRising, hwIfFluxCir=hwIfFluxCir, hwVaspPortIfIndex=hwVaspPortIfIndex, hwIfFluxDirection=hwIfFluxDirection, hwTrunkIfStatReset=hwTrunkIfStatReset, hwPortIsolationGroupEntry=hwPortIsolationGroupEntry, hwIFExtBlockPriority=hwIFExtBlockPriority, hwExtInterfaceDelete=hwExtInterfaceDelete, hwIfMonitorSdhB2ErrorThreshold=hwIfMonitorSdhB2ErrorThreshold, hwVTrunkRowStatus=hwVTrunkRowStatus, EnabledStatus=EnabledStatus, hwIfMonitorSymbolErrorThreshold=hwIfMonitorSymbolErrorThreshold, hwIfEtherStatInPkts1024to1518Octets=hwIfEtherStatInPkts1024to1518Octets, hwAdminVrrpMemberIfEntry=hwAdminVrrpMemberIfEntry, hwCppsAtmPvcGroup=hwCppsAtmPvcGroup, hwBackupStatus=hwBackupStatus, hwIFExtCompliance=hwIFExtCompliance, hwIFExtTrapConformance=hwIFExtTrapConformance, hwLogicDynamicIfSlotNumber=hwLogicDynamicIfSlotNumber, hwMasterBackupTrunkSubinterfaceEntry=hwMasterBackupTrunkSubinterfaceEntry, hwIfEtherStatOutOverflowPkts=hwIfEtherStatOutOverflowPkts, hwIfSdhStatInLongPkts=hwIfSdhStatInLongPkts, hwIfNameChangeResume=hwIfNameChangeResume, hwIfFluxLimitEntry=hwIfFluxLimitEntry, hwIfDiffServServiceClass=hwIfDiffServServiceClass, hwLogicDynamicIfCardNumber=hwLogicDynamicIfCardNumber, hwCppsPortVlanPktStatisic=hwCppsPortVlanPktStatisic, hwifMonitorBadBytesEnabledStatus=hwifMonitorBadBytesEnabledStatus, hwIfQueryEntry=hwIfQueryEntry, hwCppsAtmVpi=hwCppsAtmVpi, hwIfAtmStatOutGoodCells=hwIfAtmStatOutGoodCells, hwLogicIfHelpTableGroup=hwLogicIfHelpTableGroup, hwIfDiffServ=hwIfDiffServ, hwVaspPortPeerMac=hwVaspPortPeerMac, hwIfEtherStatInFragmentPkts=hwIfEtherStatInFragmentPkts, hwIFFlowStat=hwIFFlowStat, hwIpAdEntBcastAddr=hwIpAdEntBcastAddr, hwAutoIfIndex=hwAutoIfIndex, hwIfAtmStatTable=hwIfAtmStatTable, hwIfSdhStatInCRCPkts=hwIfSdhStatInCRCPkts, hwIFExtPhyStatus=hwIFExtPhyStatus, hwIfDiffServMode=hwIfDiffServMode, hwIfMonitorThresholdGroup=hwIfMonitorThresholdGroup, hwIfMonitorSymbolErrorInterval=hwIfMonitorSymbolErrorInterval, hwTrunkOperstatus=hwTrunkOperstatus, hwTrunkETrunkSysIDReset=hwTrunkETrunkSysIDReset, hwLacpNegotiateResume=hwLacpNegotiateResume, hwLendIpAddr=hwLendIpAddr, hwIFExtCompliances=hwIFExtCompliances, hwIfMonitorSdhErrorInterval=hwIfMonitorSdhErrorInterval, hwTrunkIfMinLinkNum=hwTrunkIfMinLinkNum, hwIfDiffServEntry=hwIfDiffServEntry, hwIfMonitorPauseContinuingEnabledStatus=hwIfMonitorPauseContinuingEnabledStatus, hwIfMonitorPauseFrameStatistics=hwIfMonitorPauseFrameStatistics, hwTrunkIfFlushPasswd=hwTrunkIfFlushPasswd, hwIfMonitorSdhB2ErrorStatistics=hwIfMonitorSdhB2ErrorStatistics, hwCppsIfStatisticsGroup=hwCppsIfStatisticsGroup, hwIfMonitorCrcErrorResume=hwIfMonitorCrcErrorResume, hwIFExtSuppressStatus=hwIFExtSuppressStatus, hwLogicIfTable=hwLogicIfTable, hwTrunkIfGroup=hwTrunkIfGroup, hwIfQuery=hwIfQuery, hwCppsResetAtmPvcStatisic=hwCppsResetAtmPvcStatisic, hwTrunkNextIndex=hwTrunkNextIndex, hwTrunkRowStatus=hwTrunkRowStatus, hwLogicIfDynamicHelpEntry=hwLogicIfDynamicHelpEntry, hwIfIpUnnumberedEntry=hwIfIpUnnumberedEntry, hwIfMonitorBadBytesErrorRising=hwIfMonitorBadBytesErrorRising, hwLogicIfHelpEntry=hwLogicIfHelpEntry, hwLinkModeChangeAutoCreateIfGroup=hwLinkModeChangeAutoCreateIfGroup, hwUnnumberedRowStatus=hwUnnumberedRowStatus, hwIfMonitorSdhErrorRising=hwIfMonitorSdhErrorRising, hwVaspPortGroup=hwVaspPortGroup, hwIfEtherStatInLongPkts=hwIfEtherStatInLongPkts)
