# Generated by Django 2.1.7 on 2019-07-15 21:10
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('networkresource', '0005_ipallocation_access_type'),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='ipmod',
            index=models.Index(fields=['ip'], name='networkreso_ip_c2cd15_idx'),
        ),
        migrations.AddIndex(
            model_name='ipmod',
            index=models.Index(fields=['client_name'], name='networkreso_client__e0ceca_idx'),
        ),
        migrations.AddIndex(
            model_name='ipmod',
            index=models.Index(fields=['product_id'], name='networkreso_product_209ab8_idx'),
        ),
    ]
